...
class OrganizationAPIView(APIView):
    ...
    def delete(self, request, pk=None):
        ...
        organization.delete()
        return Response({'status': 'organization deleted successfully'}, status=status.HTTP_204_NO_CONTENT)
...
class RepositoryAPIView(APIView):
    ...
    def delete(self, request, org_pk, repo_pk):
        ...
        repository = get_object_or_404(Repository, pk=repo_pk, organization=organization)
        repository.delete()
        return Response({'status': 'repository deleted successfully'}, status=status.HTTP_204_NO_CONTENT)
